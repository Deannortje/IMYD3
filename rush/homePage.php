                            ...
                            <div class="card-header">'.$row["username"].'</div>
                                <div class="card-body">
                                    <nav class="navbar navbar-dark bg-dark " style="width: 100%">
                                        ...
                                        <form class="commentForm" method="POST" action="albumPage.php">
                                              ...
                                              <div class="modal-body">
                                                <form method="POST" action="homePage.php" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <label style="color: black; font-family:  Rokkitt; font-size: 30px">Upload Image</label>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6">
                    ...
                    if (isset($_POST["submit"])){
                        $target_dir= "CSS-Content/gallery/";
                        ...
                        if(($uploadFile["type"] == "image/jpg" || $uploadFile["type"] == "image/jpeg") && $uploadFile["size"] < 1048576)
                        {
                            ...
                            {
                                $insertSQL = "INSERT INTO tbgallery (image_id,user_id,filename, cHeading, caption, hashtags) VALUES (null,".$userIdent.",'".$uploadFile["name"]."','".$cHeading."','".$caption."','".$hashtag."')";
